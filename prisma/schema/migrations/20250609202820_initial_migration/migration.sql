...
CREATE TABLE "Citizen" (
    ...
    "additionalInfo" TEXT,
    "driversLicense" TEXT,
    "driversLicenseCategories" TEXT,
    "driversLicensePoints" INTEGER NOT NULL DEFAULT 12,
    "pilotLicense" TEXT,
    "pilotLicenseCategories" TEXT,
    "waterLicense" TEXT,
    "waterLicenseCategories" TEXT,
    "firearmsLicense" TEXT,
    "firearmsLicenseCategories" TEXT,
    "organizationId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
